...
## Abstract
Free alternative to Zapier-WooCommerce integration. This Google App Script saves the newest WooCommerce orders in a general spreadsheet (the one where the script is applied), as well as in separated spreadsheets, one for each different order´s type.
...
Do you want to implement it? Piece of cake! Just follow two steps:
